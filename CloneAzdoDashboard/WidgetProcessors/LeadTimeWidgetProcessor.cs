...
{
  public class LeadTimeWidgetProcessor : BaseWidgetProcessor
  {
    public override string ContributionId => "ms.vss-dashboards-web.Microsoft.VisualStudioOnline.Dashboards.LeadTimeWidget";
    ...
    public override void Run(DashboardInfo_Widget1 widget, AppConfig appConfig)
    {
      ...
      var settings = JsonConvert.DeserializeObject<LeadTimeWidgetSettings>(widget.settings);
